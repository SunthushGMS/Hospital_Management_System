            ...
            <div class="flex justify-center">
                <div>
                    <div class="lg:flex justify-between">
                        <div class="flex justify-between pt-8 pb-8 pl-4 pr-4 border-none border-4 w-1/5 mr-10 ml-10 mt-10 rounded-lg shadow-2xl lg:w-110 md:w-100 ">
                            <div >
                    ...
                    <div class="w-200 h-90 shadow-2xl ml-10">
                        ...
                        <table class="table-auto w-full text-center font-semibold text-grey-400 text-center">
                            ...
                            <tr class="odd:bg-white even:bg-slate-100">
                                ...
                                <td>Heart</td>
                                <td><button class="bg-gradient-to-br from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-500 transition ease-in-out duration-500 cursor-pointer pl-4 pr-4 pt-1 pb-1 rounded text-white">Edit</button></td>
                                <td><button class="bg-gradient-to-br from-red-600 to-red-700 hover:from-red-700 hover:to-red-600 transition ease-in-out duration-500 cursor-pointer pl-4 pr-4 pt-1 pb-1 rounded text-white">Delete</button></td>
                            </tr>
                            <tr class="odd:bg-white even:bg-slate-100">
