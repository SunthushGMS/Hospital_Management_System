    ...
    <div class="flex justify-center bg-gray-50 pr-10 pl-10 pt-10 pb-10">
      ...
      <div class="flex justify-between">
        <div class="ml-12 mr-12 w-30">
          <ul>
            <li><h4 class="leading-loose text-yellow-500">RESOURCES</h4></li>
            <li><a href="" class=" text-gray-400 leading-loose hover:text-blue-700">Doctors</a></li>
            <li><a href="" class=" text-gray-400 leading-loose hover:text-blue-700">Clinics</a></li>
            <li><a href="" class=" text-gray-400 leading-loose hover:text-blue-700">Appoiments</a></li>
          </ul>
        </div>
        <div class="ml-12 mr-12 w-30">
          <ul>
            <li><h4 class=" leading-loose text-yellow-500">CONTACT</h4></li>
            <li><a href="" class=" text-gray-400 leading-loose hover:text-blue-700">About Us</a></li>
            <li><a href="" class=" text-gray-400 leading-loose hover:text-blue-700">Contact Us</a></li>
            <li><a href="" class=" text-gray-400 leading-loose hover:text-blue-700">Newsletter</a></li>
          </ul>
        </div>
        <div class="ml-12 mr-12 w-40">
          <ul>
            <li><h4 class=" leading-loose text-yellow-500">LEGAL</h4></li>
            <li><a href="" class=" text-gray-400 leading-loose hover:text-blue-700">Terms & Conditions</a></li>
            <li><a href="" class=" text-gray-400 leading-loose hover:text-blue-700">Privacy Policy</a></li>
            
          </ul>
        </div>
        <div class=" ml-10">
          <h4 class="leading-loose text-yellow-500 leading-loose">Subscribe Newsletter</h4>
